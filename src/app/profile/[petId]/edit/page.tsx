...
export default function EditPet() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setImages(petData.pet.images.map((img: { imageUrl: string }) => img.imageUrl) || [""]);
      } catch (err) {
  ...
  useEffect(() => {
    if (pet && userRoles && userRoles.clientIds.length === 0) {
      showNotification("You are not authorized to edit this pet profile.", "error");
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden border border-white p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">Edit Pet Profile</h1>
