...
import { IconPaw, IconSearch, IconMapPin, IconChevronLeft, IconChevronRight } from "@tabler/icons-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-white">
          <h2 className="text-2xl font-semibold text-gray-800 text-center mb-8">Why Choose Our Service?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-indigo-50 rounded-2xl transition-all duration-300 hover:bg-indigo-100">
              ...
              <p className="text-gray-600 text-sm">All our service providers are verified and experienced with pets.</p>
            </div>
            ...
            <div className="text-center p-6 bg-amber-50 rounded-2xl transition-all duration-300 hover:bg-amber-100">
              ...
              <p className="text-gray-600 text-sm">From grooming to walking, we offer everything your pet needs.</p>
            </div>
            ...
            <div className="text-center p-6 bg-purple-50 rounded-2xl transition-all duration-300 hover:bg-purple-100">
              ...
              <p className="text-gray-600 text-sm">Book services anytime, anywhere with our easy-to-use platform.</p>
            </div>
          </div>
        </div>
      </div>
